...
console.log(`${num_cobaias} de cobaias\n`)
console.log(`${contagem_rato} de ratos \n`)
console.log(`${contagem_coelho} de coelhos \n`)
console.log(`a porcentagem de ratos é: ${(contagem_rato * 100) / num_cobaias}%`)
console.log(`a porcentagem de coelhos é: ${(contagem_coelho * 100) / num_cobaias}`)